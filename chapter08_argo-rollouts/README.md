...
data:
  Corefile: |
    .:53 {
        ...
        # 下記追加
        hosts {
           IPアドレス app.argocd.vm61.handson.cloudnativedays.jp
           IPアドレス app-preview.argocd.vm61.handson.cloudnativedays.jp
           IPアドレス prometheus.vm61.handson.cloudnativedays.jp
           fallthrough
        }
        # ここまで
 ...
 * app.argocd.vm61.handson.cloudnativedays.jp
 * app-preview.argocd.vm61.handson.cloudnativedays.jp
