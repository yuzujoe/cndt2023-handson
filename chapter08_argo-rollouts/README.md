...
data:
  Corefile: |
    .:53 {
        ...
        # 下記追加
        hosts {
           IPアドレス app.argocd.vm30.handson.cloudnativedays.jp
           IPアドレス app-preview.argocd.vm30.handson.cloudnativedays.jp
           IPアドレス prometheus.vm30.handson.cloudnativedays.jp
           fallthrough
        }
        # ここまで
